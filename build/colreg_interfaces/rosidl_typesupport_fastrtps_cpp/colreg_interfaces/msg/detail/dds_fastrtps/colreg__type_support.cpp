...
#include "colreg_interfaces/msg/detail/colreg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const colreg_interfaces::msg::Colreg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  colreg_interfaces::msg::Colreg & ros_message)
{
  // Member: tcpa
  cdr >> ros_message.tcpa;
...
{
  auto typed_message =
    static_cast<const colreg_interfaces::msg::Colreg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<colreg_interfaces::msg::Colreg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Colreg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const colreg_interfaces::msg::Colreg *>(
...
static size_t _Colreg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Colreg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Colreg__callbacks = {
...
static rosidl_message_type_support_t _Colreg__handle = {
...
{
  return &colreg_interfaces::msg::typesupport_fastrtps_cpp::_Colreg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, colreg_interfaces, msg, Colreg)() {
  return &colreg_interfaces::msg::typesupport_fastrtps_cpp::_Colreg__handle;
}
