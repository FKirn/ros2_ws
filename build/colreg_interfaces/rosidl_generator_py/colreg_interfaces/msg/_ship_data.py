...
class Metaclass_ShipData(type):
    """Metaclass of message 'ShipData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'colreg_interfaces.msg.ShipData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ship_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ship_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ship_data
...
class ShipData(metaclass=Metaclass_ShipData):
