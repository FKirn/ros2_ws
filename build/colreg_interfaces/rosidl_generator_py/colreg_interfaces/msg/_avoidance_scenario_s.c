...
{
  /* NOTE(esteve): Call constructor of AvoidanceScenario */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("colreg_interfaces.msg._avoidance_scenario");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AvoidanceScenario");
