...
#include "colreg_interfaces/msg/detail/avoidance_scenario__rosidl_typesupport_fastrtps_c.h"
...
size_t get_serialized_size_colreg_interfaces__msg__AvoidanceScenario(
  const void * untyped_ros_message,
...
static uint32_t _AvoidanceScenario__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_colreg_interfaces__msg__AvoidanceScenario(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_colreg_interfaces
size_t max_serialized_size_colreg_interfaces__msg__AvoidanceScenario(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AvoidanceScenario__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_colreg_interfaces__msg__AvoidanceScenario(
...
static message_type_support_callbacks_t __callbacks_AvoidanceScenario = {
...
static rosidl_message_type_support_t _AvoidanceScenario__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AvoidanceScenario,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, colreg_interfaces, msg, AvoidanceScenario)() {
  return &_AvoidanceScenario__type_support;
}
