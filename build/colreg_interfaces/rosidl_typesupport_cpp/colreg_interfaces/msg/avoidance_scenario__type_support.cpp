...
static const _AvoidanceScenario_type_support_symbol_names_t _AvoidanceScenario_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, colreg_interfaces, msg, AvoidanceScenario)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, colreg_interfaces, msg, AvoidanceScenario)),
  }
};
...
{
  return &::colreg_interfaces::msg::rosidl_typesupport_cpp::AvoidanceScenario_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, colreg_interfaces, msg, AvoidanceScenario)() {
  return get_message_type_support_handle<colreg_interfaces::msg::AvoidanceScenario>();
}
