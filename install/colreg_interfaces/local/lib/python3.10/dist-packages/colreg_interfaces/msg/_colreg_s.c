...
bool colreg_interfaces__msg__colreg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("colreg_interfaces.msg._colreg.Colreg", full_classname_dest, 36) == 0);
  }
  colreg_interfaces__msg__Colreg * ros_message = _ros_message;
  {  // tcpa
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * colreg_interfaces__msg__colreg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Colreg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("colreg_interfaces.msg._colreg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Colreg");
  ...
  colreg_interfaces__msg__Colreg * ros_message = (colreg_interfaces__msg__Colreg *)raw_ros_message;
  {  // tcpa
    PyObject * field = NULL;
