...
#ifndef COLREG_INTERFACES__MSG__DETAIL__COLREG__TRAITS_HPP_
#define COLREG_INTERFACES__MSG__DETAIL__COLREG__TRAITS_HPP_
...
inline std::string to_yaml(const Colreg & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const colreg_interfaces::msg::Colreg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const colreg_interfaces::msg::Colreg & msg)
{
  return colreg_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<colreg_interfaces::msg::Colreg>()
{
  return "colreg_interfaces::msg::Colreg";
}

template<>
inline const char * name<colreg_interfaces::msg::Colreg>()
{
  return "colreg_interfaces/msg/Colreg";
}

template<>
struct has_fixed_size<colreg_interfaces::msg::Colreg>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<colreg_interfaces::msg::Colreg>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<colreg_interfaces::msg::Colreg>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // COLREG_INTERFACES__MSG__DETAIL__COLREG__TRAITS_HPP_
